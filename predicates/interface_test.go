...
func ExampleIsEOF_failingInput() {
	...
	// Output: MatchRes{type: FAILURE_EOF, dist: 9, oDist: {0 9}, match: "", rest: "abacadaba"}
}
...
func ExampleIsEOF_succeedingInput() {
	...
	// Output: MatchRes{type: SUCCESS_EOF, dist: 0, oDist: {0 0}, match: "", rest: ""}
}
...
func ExampleIsAnyRune_failingInput() {
	...
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_EOF, dist: 1, oDist: {0 1}, match: "", rest: ""}
}
...
func ExampleIsAnyRune_succeedingInput01() {
	...
	// Output: MatchRes{type: SUCCESS_RUNE, dist: 0, oDist: {0 0}, match: "a", rest: "bacadaba"}
}
...
func ExampleIsAnyRune_succeedingInput02() {
	...
	// Output: MatchRes{type: SUCCESS_RUNE, dist: 0, oDist: {0 0}, match: "1", rest: "23abc"}
}
...
func ExampleIsAnyRune_succeedingInput03() {
	...
	// Output: MatchRes{type: SUCCESS_RUNE, dist: 0, oDist: {0 0}, match: "世", rest: "界"}
}
...
func ExampleIsRune_failingInput02() {
	...
	// Output: MatchRes{type: FAILURE_NO_MATCH, dist: 9, oDist: {1 8}, match: "", rest: "abacadaba"}
}
...
func ExampleIsRune_failingInput03() {
	...
	// Output: MatchRes{type: FAILURE_NO_MATCH, dist: 6, oDist: {1 5}, match: "", rest: "123abc"}
}
...
func ExampleIsRune_succeedingInput02() {
	...
	expectedSucceedingMatch := IsRune(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_RUNE, dist: 0, oDist: {0 0}, match: "世", rest: "界abc"}
}
...
func ExampleIsRune_succeedingInput03() {
	...
	expectedSucceedingMatch := IsRune(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_RUNE, dist: 0, oDist: {0 0}, match: "世", rest: "界123"}
}
...
func ExampleIsStr_failingInput01() {
	...
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_EOF, dist: 2, oDist: {0 2}, match: "", rest: ""}
}
...
func ExampleIsStr_failingInput02() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NO_MATCH, dist: 2, oDist: {2 0}, match: "", rest: "abacadaba"}
}
...
func ExampleIsStr_failingInput03() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NO_MATCH, dist: 2, oDist: {2 0}, match: "", rest: "123abc"}
}
...
func ExampleIsStr_failingInput04() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_MATCH_THEN_EOF, dist: 1, oDist: {0 1}, match: "", rest: "世"}
}
...
func ExampleIsStr_failingInput05() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NEAR_MISS_THEN_EOF, dist: 1, oDist: {1 1}, match: "", rest: "界"}
}
...
func ExampleIsStr_succeedingInput01() {
	...
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_STRING, dist: 0, oDist: {0 0}, match: "世界", rest: ""}
}
...
func ExampleIsStr_succeedingInput02() {
	...
	expectedSucceedingMatch := IsStr(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_STRING, dist: 0, oDist: {0 0}, match: "世界", rest: "abacadaba"}
}
...
func ExampleIsStr_succeedingInput03() {
	...
	expectedSucceedingMatch := IsStr(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_STRING, dist: 0, oDist: {0 0}, match: "世界", rest: "123abc"}
}
...
func ExampleIsStr_failingInput06() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_EOF, dist: 11, oDist: {0 11}, match: "", rest: ""}
}
...
func ExampleIsStr_failingInput07() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NO_MATCH_THEN_EOF, dist: 9, oDist: {8 2}, match: "", rest: "abacadaba"}
}
...
func ExampleIsStr_failingInput08() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NEAR_MISS_THEN_EOF, dist: 2, oDist: {1 1}, match: "", rest: "secondm@tc"}
}
...
func ExampleIsStr_failingInput09() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NEAR_MISS, dist: 1, oDist: {1 0}, match: "", rest: "secondm@tch"}
}
...
func ExampleIsStr_failingInput10() {
	...
	expectedFailingMatch := IsStr(toMatch)(failingInput)
	fmt.Println(expectedFailingMatch)
	// Output: MatchRes{type: FAILURE_NEAR_MISS, dist: 1, oDist: {1 0}, match: "", rest: "secondm@tch123abc"}
}
...
func ExampleIsStr_succeedingInput04() {
	...
	expectedSucceedingMatch := IsStr(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_STRING, dist: 0, oDist: {0 0}, match: "secondmatch", rest: ""}
}
...
func ExampleIsStr_succeedingInput05() {
	...
	expectedSucceedingMatch := IsStr(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_STRING, dist: 0, oDist: {0 0}, match: "secondmatch", rest: "123"}
}
...
func ExampleIsStr_succeedingInput06() {
	...
	expectedSucceedingMatch := IsStr(toMatch)(succeedingInput)
	fmt.Println(expectedSucceedingMatch)
	// Output: MatchRes{type: SUCCESS_STRING, dist: 0, oDist: {0 0}, match: "secondmatch", rest: "abacadaba"}
}
